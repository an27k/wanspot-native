...
const IconBulb = ({ fill }: { fill: string }) => (
  <Svg width={13} height={13} viewBox="0 0 512 512" fill={fill}>
    <Path d="M256,0C165.531,0,92.219,73.313,92.203,163.781c0,57.125,29.266,107.5,73.594,136.75c5.203,3.438,8.75,6.375,11.094,8.875c3.453,3.813,4.688,6.266,5.891,11.156c1.141,4.844,1.531,12.281,1.516,22.844V359h143.422v-15.594c-0.016-7.031,0.141-12.719,0.594-17.125c0.344-3.313,0.859-5.906,1.5-7.984c1.016-3.141,2.156-5.25,4.469-7.984c2.328-2.688,6.063-5.906,11.922-9.781c44.328-29.25,73.594-79.625,73.594-136.75C419.797,73.313,346.469,0,256,0z" />
  </Svg>
)
...
const IconHot = ({ fill }: { fill: string }) => (
  <Svg width={13} height={13} viewBox="0 0 512 512" fill={fill}>
    <Path d="M404.563,188.938c-23.078-36.063-38.953-60.578-64.906-121.156c0,0-18.75,24.531-33.172,60.578c-6.703-23.203-18.922-33.578-33.172-57.703C254.563,38.938,251.672,0,251.672,0s-30.281,17.313-50.484,60.563c-20.172,43.281-18.75,93.75-41.813,116.844c-8.656-46.156-30.297-59.125-30.297-59.125s-12.984,38.906-21.625,64.875c-23.078,46.156-37.5,91.406-37.5,142.797c0,51.359,20.813,97.891,54.5,131.547C158.125,491.188,204.641,512,256,512c51.375,0,97.891-20.813,131.563-54.5c33.672-33.656,54.484-80.188,54.484-131.547C442.047,274.563,424.766,223.547,404.563,188.938z" />
  </Svg>
)
