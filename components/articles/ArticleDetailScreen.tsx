...
import { UiIconChevronLeft, UiIconGoogle, UiIconStar, UiPriceLevelYen } from '@/components/ui-icons'
...
const IconChevron = () => <UiIconChevronLeft />

const IconStarSm = () => <UiIconStar size={11} />

function PriceLevel({ level }: { level: number | null }) {
  if (level === null || level === undefined) {
    return <Text style={styles.plQ}>?</Text>
  }
  return <UiPriceLevelYen level={level} dotSize={10} />
}

const IconGoogle = () => <UiIconGoogle />
