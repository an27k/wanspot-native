...
const styles = StyleSheet.create({
  ...
  h: { fontSize: 14, fontWeight: '900', color: '#1a1a1a' },
  ...
  modalTitle: { fontSize: 14, fontWeight: '900', color: '#1a1a1a', marginBottom: 10 },
  ...
  sizeRowTxt: { fontSize: 12, fontWeight: '800', color: '#1a1a1a' },
})
